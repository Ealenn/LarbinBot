...
export interface ICommand {
  ...
  Action(twitchService: ITwitchService, fullMessage: string, state: ChatUserstate, stats: ICommandStats): Promise<void>;
...
export abstract class BaseCommand implements ICommand {
  ...
  abstract Action(twitchService: ITwitchService, fullMessage: string, userState: ChatUserstate, stats: ICommandStats): Promise<void>;
